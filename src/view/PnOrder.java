...
public class PnOrder extends JPanel {
	/**
	 * 
	 */
...
//	private JTextField tfName;
	...
	private MyButton btnChonMon;
	private String[] arrBanChonMoi = new String [12];
...
//	private MyButton btnNext;
	...
	public String[] getArrBanChonMoi() {
		return arrBanChonMoi;
	}
	public void setArrBanChonMoi(String[] arrBanChonMoi) {
		this.arrBanChonMoi = arrBanChonMoi;
	}
...
//		btnNext.setBounds(669, 583, 89, 30);
//		add(btnNext);
		
		btnChonMon = new MyButton();
		btnChonMon.setText("Chọn Món");
		btnChonMon.setRadius(30);
		btnChonMon.setBorder(null);
		btnChonMon.setColor(new Color(21, 51, 238));
		btnChonMon.setForeground(Color.white);
		btnChonMon.setColorOver(new Color(68, 173, 239));
		btnChonMon.setColorClick(new Color(27, 100, 213));
		btnChonMon.setBorderColor(new Color(123, 195, 241));
		btnChonMon.setFont(new Font("Tahoma", Font.BOLD, 15));
		
		

		btnChonMon.setBounds(48, 520, 137, 44);
		add(btnChonMon);
...
//		btnEdit.setBounds(804, 583, 89, 30);
//		add(btnEdit);
//		
...
//		btnCancel.setBounds(923, 583, 89, 30);
//		add(btnCancel);
						...
						for(int i = 0; i < 12; i ++)
						{
							...
							if(e.getSource() == arrlbl[i] )
							{
								if(seatSelected[i] == "0"  && arrSelected[i] == "0"  ) {
									...
									arrBanChonMoi[i] = arrlbl[i].getText();
								}
...
//							{
//								
//								if(e.getSource() == arrlbl[i] && !(arrlbl[i].getText().equals(ban)))
//								{
//									if(seatSelected[i] == "0"  && arrSelected[i] == "0"  ) {
//										arrlbl[i].setBackground(Color.red);
//										arrSelected[i] = "1";
...
//		btnChonBan.addMouseListener(action);
//	}
	
	public void addNextActionListener(ActionListener action) {
		btnChonMon.addActionListener(action);
	}
//	
