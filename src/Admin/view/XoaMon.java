...
public class XoaMon extends JFrame {
	 ...
	 * Create the frame.
	 */
	public XoaMon(HomeAdmin homeAdminView) {
		...
		btnNewButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				ArrayList<Mon> listMon = MonDAO.getInstance().selectByCondition(condition);
					...
					for(Mon mon: listMon) {
						int id = mon.getId();
						Mon monDeleted = new Mon(id,tenMon, loai, gia, anhMinhHoa);
						
						MonDAO.getInstance().delete(monDeleted);
